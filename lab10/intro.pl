...
sameTree(A, B):-
	descendantOf(A, B); descendantOf(B, A); 
	nod(C), descendantOf(B, C), descendantOf(A, C).
...
cost(N, N, 0).
cost(N1, N2, 1):- arc(N1, N2).
cost(N1, N2, -1):- arc(N2, N1).
cost(N1, N2, Cnew):- arc(N1, N3), descendantOf(N2, N3), cost(N3, N2, C), Cnew is C + 1.
cost(N1, N2, Cnew):- arc(N3, N1), cost(N3, N2, C), Cnew is C - 1.
