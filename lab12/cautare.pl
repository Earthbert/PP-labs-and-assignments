...
safeTaran([X, Y]) :- X = varza, Y = lup.
safeTaran([X, Y]) :- X = lup, Y = varza.
safeTaran([]).
safeTaran(L) :- member(varza, L), member(capra, L), !, false.
safeTaran(L) :- member(lup, L), member(capra, L), !, false.
safeTaran([_]).
...
% problemă.
safeMisionari(NM, NC) :- NC > NM, NM \= 0, !, false.
safeMisionari(_, _).
...
parseState((Mal, NM_Est, NC_Est), Mal, NM_Est, NC_Est, NM_Vest, NC_Vest) :-
    NM_Vest is 3 - NM_Est,
    NC_Vest is 3 - NC_Est.
...
gen_people_pos(est, NM_Est, NC_Est, NM_Vest, NC_Vest, NM_Est_Next, NC_Est_Next, NM_Vest_Next, NC_Vest_Next) :-
    boat(X, Y),
    NM_Est_Next is NM_Est - X, NM_Est_Next >= 0,
    NC_Est_Next is NC_Est - Y, NC_Est_Next >= 0,
    NM_Vest_Next is NM_Vest + X, NM_Vest_Next =< 3,
    NC_Vest_Next is NC_Vest + Y, NC_Vest_Next =< 3.

gen_people_pos(west, NM_Est, NC_Est, NM_Vest, NC_Vest, NM_Est_Next, NC_Est_Next, NM_Vest_Next, NC_Vest_Next) :-
    boat(X, Y),
    NM_Est_Next is NM_Est + X, NM_Est_Next =< 3,
    NC_Est_Next is NC_Est + Y, NC_Est_Next =< 3,
    NM_Vest_Next is NM_Vest - X, NM_Vest_Next >= 0,
    NC_Vest_Next is NC_Vest - Y, NC_Vest_Next >= 0.

next_state(misionari, S1, S2) :-
    parseState(S1, Mal, NM_Est, NC_Est, NM_Vest, NC_Vest),
    gen_people_pos(Mal, NM_Est, NC_Est, NM_Vest, NC_Vest, NM_Est_Next, NC_Est_Next, NM_Vest_Next, NC_Vest_Next),
    safeMisionari(NM_Vest_Next, NC_Vest_Next),
    safeMisionari(NM_Est_Next, NC_Est_Next),
    opus(Mal, NextMal),
    parseState(S2, NextMal, NM_Est_Next, NC_Est_Next, NM_Vest_Next, NC_Vest_Next).
